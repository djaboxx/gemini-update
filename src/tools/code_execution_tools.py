...
"""
    ...
    async def analyze_codebase_with_gemini(
        ...
        This tool instructs Gemini to generate Python code that defines an 'analyze()' function, which will be executed to analyze the codebase. The analyze() function must return a dictionary with the following structure:
        {
